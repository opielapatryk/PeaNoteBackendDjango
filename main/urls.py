...
from .views import Settings, Register, Login, Friend, Friends, Index, Logout, SearchFriend, UserViewSet, StickerViewSet, get_csrf_token, CustomLoginView,CustomLogoutView, CustomRegisterView
